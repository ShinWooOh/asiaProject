	                		...
	                		<table class="table table-bordered">
	                			<tbody>
	                				...
	                				<tr>
	                					<th>주소</th>
	                					<td> 
	                						<input type="text" id="sample4_postcode" name="postCode" placeholder="우편번호" style="margin-bottom: 5px;" value="${storeDetail.postCode}">
											<input id ="findAddress" type="button" onclick="execDaumPostcode()" value="우편번호 찾기" style="margin-bottom: 5px;"><br>
											<input type="text" id="sample4_roadAddress" name="roadAddress" placeholder="도로명주소" value="${storeDetail.roadAddress}" style="margin-top:5px; margin-bottom:5px; width:300px;"><br>
											<span id="guide" style="color:#999;display:none"></span>
											<input type="text" id="sample4_jibunAddress" name="jibunAddress" placeholder="지번주소" value="${storeDetail.jibunAddress}" style="width: 300px;">
											<input type="text" id="sample4_detailAddress" name="detailAddress" placeholder="상세주소" value="${storeDetail.detailAddress}" style="width: 300px;">
											<input type="text" id="sample4_extraAddress" name="extraAddress" placeholder="참고항목"  value="${storeDetail.extraAddress}" style="width: 100px;">
	                					</td>
                					</tr>
