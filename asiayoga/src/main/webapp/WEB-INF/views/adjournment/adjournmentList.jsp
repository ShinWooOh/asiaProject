		                            		...
		                            		<td>
		                            			<c:choose>
		                            				<c:when test="${adjournmentList.adjournmentState eq 'Y'}">
					                            		<input type="button" class="btn btn-block btn-warning btn-sm" onclick="goAdjournmentStateChange(${adjournmentList.adjournmentSeq},'${adjournmentList.adjournmentState}');" id="adjournmentState" name="adjournmentState" value="휴회중"> 
		                            				</c:when>
		                            				<c:when test="${adjournmentList.adjournmentState eq 'N'}">
					                            		<input type="button" class="btn btn-block btn-info btn-sm" onclick="goAdjournmentStateChange(${adjournmentList.adjournmentSeq},'${adjournmentList.adjournmentState}');" id="adjournmentState" name="adjournmentState" value="미휴회"> 
		                            				</c:when>
...
function goAdjournmentStateChange(adjournmentSeq,adjournmentState){
